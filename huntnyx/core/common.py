...
class UI:
    ...
    @classmethod
    def banner(cls):
        # Συνδυάζουμε HUNT και NYX σε μία γραμμή
        art = [h + "  " + n for h, n in zip(cls._word("HUNT"), cls._word("NYX"))]
...
ENGINE_TOOLS = ("gobuster", "feroxbuster", "ffuf", "arjun", "sqlmap", "dalfox", "subfinder")
